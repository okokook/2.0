define(function(require, exports, module) {
	(function(e, d, a, f) {
		...
		c.prototype = {
			constructor: c,
			init: function(g) {
				this.options = e.extend({}, this.options, g);
			...
			buildItem: function(i, j) {
				...
				h.append(k.attr("href", this.href(j)).html(g));
				return h
			},
			getPages: function(j) {
				var g = [];
			...
			render: function(g) {
				...
				this.$listContainer.find(".first").toggleClass("disabled", g.currentPage === 1);
				this.$listContainer.find(".last").toggleClass("disabled", g.currentPage === this.options.totalPages);
				this.$listContainer.find(".prev").toggleClass("disabled", g.currentPage === 1);
			...
			setupEvents: function() {
				...
				this.$listContainer.find("li").each(function() {
					var h = e(this);
					h.off();
					if (h.hasClass("disabled") || h.hasClass("active")) {
						return
					}
					h.click(function() {
		...
		e.fn.twbsPagination.defaults = {
			totalPages: OP_CONFIG.totalPages,
			startPage: 1,
			visiblePages: 8,
